...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2['default'].render(_Routes2['default'], document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SomePage = __webpack_require__(208);
	...
	var Routes = React.createElement(
	    ...
	    React.createElement(
	        Route,
	        { path: '/', component: Main },
	        React.createElement(Route, { path: '/some', component: SomePage })
	    )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewItems = __webpack_require__(210);
	
	var _ViewItems2 = _interopRequireDefault(_ViewItems);
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_ViewItems2['default'], { items: this.state.items })
	            );
	        }
	    }]);
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement('input', { value: this.props.inputValue, onChange: this.props.handleChange }),
	                _react2['default'].createElement(
	                    'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewItems = (function (_React$Component) {
	    _inherits(ViewItems, _React$Component);
	
	    function ViewItems() {
	        _classCallCheck(this, ViewItems);
	
	        _get(Object.getPrototypeOf(ViewItems.prototype), 'constructor', this).call(this);
	        this.state = {
	            color: '',
	            rowId: ''
	        };
	    ...
	    _createClass(ViewItems, [{
	        key: 'handleColor',
	        value: function handleColor(e) {
	        ...
	        value: function render() {
	            ...
	            if (this.props.items.length > 0) {
	                this.props.items.map(function (item) {
	                    if (_this.state.rowId == item.id) {
	                        rows.push(_react2['default'].createElement(
	                            'tr',
	                            { style: { backgroundColor: _this.state.color }, onClick: _this.handleColor.bind(_this) },
	                            _react2['default'].createElement(
	                                'td',
	                                { id: item.id },
	                                item.item
	                        ...
	                        rows.push(_react2['default'].createElement(
	                            'tr',
	                            { onClick: _this.handleColor.bind(_this) },
	                            _react2['default'].createElement(
	                                'td',
	                                { id: item.id },
	                                item.item
